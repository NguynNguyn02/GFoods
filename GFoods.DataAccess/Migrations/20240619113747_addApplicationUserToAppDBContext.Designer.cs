...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GFoods.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fdf13906-e523-45b8-a093-a3b078762205",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5e8ddfdc-3f99-4090-9db3-a006d5d89639",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c1b22d52-e488-47f0-9f57-14b9d07e9cde",
            ...
            modelBuilder.Entity("GFoods.Models.OrderDetail", b =>
                {
                    b.HasOne("GFoods.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GFoods.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("GFoods.Models.OrderHeader", b =>
                {
                    b.HasOne("GFoods.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
